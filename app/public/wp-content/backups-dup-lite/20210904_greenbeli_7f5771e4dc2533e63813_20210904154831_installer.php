...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210904_greenbeli_7f5771e4dc2533e63813_20210904154831_archive.zip';
	const ARCHIVE_SIZE		 = '87738456';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '7f5771e-04154831';
    const SECONDARY_PACKAGE_HASH = 'fbd32cd-04154831';
	const VERSION			 = '1.4.2';
