...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210917_greenbeli_370fc69ea522c2613987_20210917170354_archive.zip';
	const ARCHIVE_SIZE		 = '49376369';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '370fc69-17170354';
    const SECONDARY_PACKAGE_HASH = '5adee6a-17170354';
	const VERSION			 = '1.4.3';
